...
def get_TO_BE_DATA_ITEMS (raw_file_path, cooked_conn_str, cooked_db_name, cooked_coll):
...
def get_LIST_to_be_SELECTED_with_data_items ( raw_folder_path, raw_raw_start_file_index, raw_raw_end_file_index, cooked_conn_str, cooked_db_name, cooked_start_coll_index, cooked_end_coll_index):
   ...
   for raw_file, cooked_coll zip(LIST_raw_file_SELECTED, LIST_cooked_coll_SELECTED):

      LIST_to_be_file_data_SELECTED.append( raw_file + ' #_0 ' +  get_TO_BE_DATA_ITEMS (raw_file_path=raw_file_path, cooked_conn_str=cooked_conn_str, cooked_db_name=cooked_db_name, cooked_coll=cooked_coll))
...
## do_one_DATA_ITEM --> CF_data_chunk (LIST_item) --> CF_all_data_chunk (raw_start_file, raw_end_file, raw_folder_path, cooked_folder_path, start_index, items_per_list)
...
def CF_all_data_chunk (raw_folder_path, raw_file_path, raw_start_file_index, raw_end_file_index, cooked_conn_str, cooked_db_name, cooked_coll, cooked_doc_key, cooked_start_coll_index, cooked_end_coll_iondex, start_index, items_per_list, do_one_DATA_ITEM):
  
   # LIST TO_BE file & data
   LIST_to_be_file_data = get_LIST_to_be_SELECTED_with_data_items (raw_start_file = raw_start_file, raw_end_file = raw_end_file, raw_folder_path = raw_folder_path, cooked_folder_path = cooked_folder_path )
   ...
   for data_file in LIST_to_be_file_data[start_file_index:end_file_index]:
      ...
      for data_items in LIST_data_item_only:
         ...
         LIST_data_item_chunk = split_to_be_DATA_ITEMS (raw_file_path = raw_file_path, cooked_file_path = cooked_file_path, start_index=start_index, items_per_list=items_per_list)
