...
def get_LIST_to_be_SELECTED_with_data_items (raw_folder_path, raw_start_file_index, raw_end_file_index, cooked_folder_path, cooked_start_file_index, cooked_end_file_index):
   ...
   LIST_cooked_file_SELECTED = get_LIST_cooked_SELECTED (cooked_folder_path=cooked_folder_path, cooked_start_file_index=cooked_start_file_index, cooked_end_file_index=cooked_end_file_index)
...
#get_LIST_to_be_SELECTED_with_data_items (raw_folder_path, raw_start_file_index, raw_end_file_index, cooked_folder_path, cooked_start_file_index, cooked_end_file_index)
...
def CF_all_data_chunk (raw_folder_path, raw_file_path, raw_start_file_index, raw_end_file_index, cooked_folder_path, cooked_file_path, cooked_Start_file_index, cooked_end_file_index, start_index, items_per_list, do_one_DATA_ITEM):
  
   # LIST TO_BE file & data
   LIST_to_be_file_data = get_LIST_to_be_SELECTED_with_data_items (raw_folder_path=raw_folder_path, raw_start_file_index=raw_start_file_index, raw_end_file_index=raw_end_file_index, cooked_folder_path=cooked_folder_path, cooked_start_file_index=cooked_start_file_index, cooked_end_file_index=cooked_end_file_index)
   ...
   for data_file in LIST_to_be_file_data[start_file_index:end_file_index]:
      ...
      for data_items in LIST_data_item_only:
         ...
         LIST_data_itek_chunk = split_to_be_DATA_ITEMS (raw_file_path = raw_file_path, cooked_file_path = cooked_file_path, start_index=start_index, items_per_list=items_per_list)
