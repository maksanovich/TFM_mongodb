...
def CF_all_data_chunk (raw_folder_path, raw_file_path, raw_start_file_index, raw_end_file_index, cooked_conn_str, cooked_db_name, cooked_coll, cooked_doc_key, cooked_start_coll_index, cooked_end_coll_iondex, start_index, items_per_list):
