...
#input_search_bar (path_Chromedriver = "../../data/raw/Chromedrivers/chromedriver-win64/chromedriver.exe", url='https://google.com', Xpath_value = '//*[@name="q"]', search_query='python coding', remove_after_text='python')
