...
def CF_all_data_chunk (raw_folder_path, raw_file_path, raw_start_file_index, raw_end_file_index, cooked_folder_path, cooked_file_path, cooked_Start_file_index, cooked_end_file_index, start_index, items_per_list):
