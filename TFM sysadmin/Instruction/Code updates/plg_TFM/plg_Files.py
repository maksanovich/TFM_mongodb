...
def File_write (file_path, write_mode, LIST_line):

   with open(file_path , write_mode) as file_1:
      # Writing data to a file
      #file1.write("Hello \n")
      file_1.writelines(LIST_line)
...
#print (File_read_lines (file_path='test_code.py'))
...
def get_file_size_4 (file_path_4):
