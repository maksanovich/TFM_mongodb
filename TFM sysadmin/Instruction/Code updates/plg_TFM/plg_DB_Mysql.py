...
# select data where....
def Mysql_select_tb_data (My_host, My_user, My_pass , My_db_name, My_select_query):
...
#print (Mysql_select_tb_data (My_host='localhost', My_user='root', My_pass='' , My_db_name = 'rajesh_db', My_select_query='''))
