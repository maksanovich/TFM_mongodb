...
def get_ALL_in_folder (folder_path):
...
#print(get_ALL_in_folder (folder_path ='../../data/raw/'))

#print (len(get_ALL_in_folder (folder_path=('../../data/cooked/DB_squ/'))))



def get_ALL_subfolders_files_in_parent_folder (parent_folder_path):
...
def remove_ALL_folder_items (folder_path):
...
def copy_folderA_to_folderB (folderA_path, folderB_path):
